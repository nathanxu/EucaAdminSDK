...
public class EucaIAMClient extends AmazonWebServiceClient implements AmazonIdentityManagement {
    ...
    /** delegate account, extend by Eucalyptus for admin only */
     ...
     * @see DefaultAWSCredentialsProvider
     */
    public EucaIAMClient(ClientConfiguration clientConfiguration) {
     ...
     */
    public EucaIAMClient(AWSCredentials awsCredentials) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public EucaIAMClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration) {
     ...
     */
    public EucaIAMClient(AWSCredentialsProvider awsCredentialsProvider) {
     ...
     *                       (ex: proxy settings, retry counts, etc.).
     */
    public EucaIAMClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
        super(clientConfiguration);
    ...
    public void setDelegateAccount(String account) {
    	this.delegateAccount = account;
    }
    
    /**
     * Create a account,this is extended by Eucalyptus
    ...
    public CreateAccountResult CreateAccount(CreateAccountRequest createAccountRequest) 
        ...
        Request<CreateAccountRequest> request = new CreateAccountRequestMarshaller().marshall(createAccountRequest);
        return invoke(request, new CreateAccountResultStaxUnmarshaller());
    }
    ...
    public void DeleteAccount(DeleteAccountRequest deleteAccountRequest) 
            throws AmazonServiceException, AmazonClientException {
        Request<DeleteAccountRequest> request = new DeleteAccountRequestMarshaller().marshall(deleteAccountRequest);
        invoke(request, null);
    }
    ...
    public ListAccountsResult ListAccounts() 
    	...
    	Request<ListAccountsRequest> request = new ListAccountsRequestMarshaller().marshall(listAccountsRequest);
        return invoke(request, new ListAccountsResultStaxUnmarshaller());
    }
    /**
     * get the policy name list for a account
     * @param listAccountPoliciesRequest
     * @return
     * @throws AmazonServiceException
     * @throws AmazonClientException
     */
    public ListAccountPoliciesResult ListAccountPolicies(ListAccountPoliciesRequest listAccountPoliciesRequest) 
            throws AmazonServiceException, AmazonClientException {
    	Request<ListAccountPoliciesRequest> request = new ListAccountPoliciesRequestMarshaller().marshall(listAccountPoliciesRequest);
        return invoke(request, new ListAccountPoliciesResultStaxUnmarshaller());
    }
    
    /**
     * return the content of policy associated to account
     * @param getAccountPolicyRequest
     * @return GetAccountPolicyResult
     * @throws AmazonServiceException
     * @throws AmazonClientException
     */
    public GetAccountPolicyResult GetAccountPolicy(GetAccountPolicyRequest getAccountPolicyRequest) 
            throws AmazonServiceException, AmazonClientException {
    	Request<GetAccountPolicyRequest> request = new GetAccountPolicyRequestMarshaller().marshall(getAccountPolicyRequest);
        return invoke(request, new GetAccountPolicyResultStaxUnmarshaller());
    }
    
    /**
     * put account policy
     * @param addAccountPolicyRequest
     * @throws AmazonServiceException
     * @throws AmazonClientException
     */
    public void AddAccountPolicy(AddAccountPolicyRequest addAccountPolicyRequest) 
            throws AmazonServiceException, AmazonClientException {
        Request<AddAccountPolicyRequest> request = new AddAccountPolicyRequestMarshaller().marshall(addAccountPolicyRequest);
        invoke(request, null);
    }
    
    /**
     * delete a policy associated to an account
     * @param deleteAccountPolicyRequest
     * @throws AmazonServiceException
     * @throws AmazonClientException
     */
    public void DeleteAccountPolicy(DeleteAccountPolicyRequest deleteAccountPolicyRequest) 
            throws AmazonServiceException, AmazonClientException {
        Request<DeleteAccountPolicyRequest> request = new DeleteAccountPolicyRequestMarshaller().marshall(deleteAccountPolicyRequest);
        invoke(request, null);
    }
    ...
    private <X, Y extends AmazonWebServiceRequest> X invoke(Request<Y> request, Unmarshaller<X, StaxUnmarshallerContext> unmarshaller) {
        ...
        if (this.delegateAccount !=null ) {
        	request.addParameter("DelegateAccount",StringUtils.fromString(delegateAccount));
        }
